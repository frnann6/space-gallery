  ...
  gallery.innerHTML += `
    <div class="col-12 col-md-4">
      <div class="gallery-card p-2 text-center rounded-4 planet-box" data-slug="${planet.slug}">
        ...
        <h5 class="text-light fw-bold text-center ps-2 mt-3">${planet.name} <span class="arrow"><svg stroke="currentColor"
                                fill="currentColor" stroke-width="0" viewBox="0 0 448 512" class="ms-2" height="1em"
